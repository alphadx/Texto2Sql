...
- [ ] **Copilot** (escenario enterprise): evaluar alcance técnico real para uso como backend programático. *(Hito 0 de alineación documentado en `docs/providers/copilot.md`.)*
