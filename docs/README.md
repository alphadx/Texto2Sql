...
- [ ] **Hugging Face Inference**: definir integración (serverless/dedicated endpoint), autenticación y límites. *(Hitos 0 y 1 documentados, con avance inicial de Hito 2 en `docs/providers/huggingface.md`.)*
