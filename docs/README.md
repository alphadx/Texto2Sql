...
- [ ] **Gemini (Google)**: agregar cliente/API, mapeo de modelos y estrategia de prompts equivalente. *(Hitos 0 y 1 documentados en `docs/providers/gemini.md`; pendiente implementación.)*
